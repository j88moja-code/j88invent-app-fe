    ...
    <div className="home">
      ...
      <section className="container hero">
        <div className="hero-text">
          <h2>MERN App for Inventory and Stock Management</h2>
          <p>
            Inventory system to control and manage inventory in the warehouse in
          ...
          <div className="--flex-start">
            <NumberText num="8K" text="Brand Owners" />
